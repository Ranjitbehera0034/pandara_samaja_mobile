...
import { extractYouTubeId, extractYouTubeChannelUrl } from '../../utils/youtube';
...
export default function PostCard({
  ...
  const facebookUrl = !youtubeId && !youtubeChannelUrl ? extractFacebookUrl(post.content) : null;
  ...
  return (
    ...
    >
      ...
      <View style={{ marginBottom: spacing.md }}>
        ...
        {!isEditing && youtubeChannelUrl && <YouTubeChannelCard url={youtubeChannelUrl} />}
