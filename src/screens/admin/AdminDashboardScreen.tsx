...
import { Users, Flag, ShieldCheck, LogOut, ChevronRight, History, Heart, Newspaper, Megaphone, Wallet, Settings as SettingsIcon, Award, PieChart, TrendingUp, Radio, Download, Briefcase, AlertTriangle, GraduationCap, Mic2 } from 'lucide-react-native';
...
export default function AdminDashboardScreen() {
  ...
  const cards = [
    ...
    {
      key: 'jobs',
      icon: <Briefcase size={24} color={C.primary} />,
      title: t('admin', 'jobsCardTitle'),
      desc: t('admin', 'jobsCardDesc'),
      onPress: () => navigateTo('AdminJobs'),
    },
    {
      key: 'courses',
      icon: <GraduationCap size={24} color={C.primary} />,
      title: t('admin', 'coursesCardTitle'),
      desc: t('admin', 'coursesCardDesc'),
      onPress: () => navigateTo('AdminCourses'),
    },
    {
      key: 'songContest',
      icon: <Mic2 size={24} color={C.accent} />,
      title: t('admin', 'songContestsCardTitle'),
      desc: t('admin', 'songContestsCardDesc'),
      onPress: () => navigateTo('AdminSongContests'),
    },
    {
      key: 'expenses',
    ...
    {
      key: 'live',
      icon: <Radio size={24} color={C.error} />,
      title: t('admin', 'liveCardTitle'),
      desc: t('admin', 'liveCardDesc'),
      onPress: () => navigateTo('AdminLive'),
    },
    {
      key: 'export',
      icon: <Download size={24} color={C.accent} />,
      title: t('admin', 'exportCardTitle'),
      desc: t('admin', 'exportCardDesc'),
      onPress: () => navigateTo('AdminExport'),
    },
    {
      key: 'settings',
